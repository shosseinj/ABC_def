...
def write_report(epoch_rows, selection_rows, attack_rows, summary_rows, pareto_rows, gate, selected_epochs):
    ...
    lines = [
        ...
        "# 4. Regression Status", "", "Recorded after the Phase 17.3 gate and full pytest verification; see the final execution report.", "",
        ...
        "# 18. Root-Cause Update", "", f"The current loss tie-break selected seed-777 epoch {seed777_a['selected_epoch']}; accuracy-stable selected epoch {seed777_b['selected_epoch']}. Checkpoint selection is a material contributor only if the generic cross-seed gate passes; otherwise it is at most a seed-specific contributor.", "",
        ...
        f"9. Class-1/class-2 compression remains: **{'no' if passing else 'yes or unresolved'}**.",
